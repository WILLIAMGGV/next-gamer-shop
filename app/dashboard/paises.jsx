  ...
  const handleSubmit = async (e) => {
    ...
    if (estado == 0) {
      ...
      const res = await axios.put(
        `${process.env.NEXT_PUBLIC_API_KEY}/api/pais/${valorid}`,
        paises
      );
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <svg
                          className="w-[24px] h-[24px] text-gray-800 hover:text-blue-600 dark:text-white cursor-pointer"
                          aria-hidden="true"
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                          height="24"
